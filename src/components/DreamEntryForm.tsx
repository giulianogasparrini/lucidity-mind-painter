...
const DreamEntryForm: React.FC<DreamEntryFormProps> = ({ onSubmit }) => {
    ...
    if (!isRecording) {
      ...
      setTimeout(() => {
        ...
        setContent(prevContent => prevContent + (prevContent ? ' ' : '') + 
          "I was flying over a city I didn't recognize, with buildings that shifted and changed as I watched...");
  ...
  return (
    <form onSubmit={handleSubmit} className="dream-card p-5 animate-fade-in">
      <h2 className="text-xl font-semibold mb-4 text-dream-darkpurple">Record a New Dream</h2>
